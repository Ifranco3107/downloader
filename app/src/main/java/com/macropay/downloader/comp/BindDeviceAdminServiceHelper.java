...
public class BindDeviceAdminServiceHelper<T> {
    ...
    public BindDeviceAdminServiceHelper(
        ...
        Log.INSTANCE.msg(TAG,"[BindDeviceAdminServiceHelper] -1-");
     //   try{
            mContext = context;
       ...
       // }catch (Exception ex){
        //    ErrorMgr.INSTANCE.guardar(TAG,"BindDeviceAdminServiceHelper",ex.getMessage());
       // }
    ...
    public boolean crossUserCall(OnServiceConnectedListener<T> listener) {
        final ServiceConnection serviceConnection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                Log.INSTANCE.msg(TAG, "onServiceConnected() called");
                T service = mServiceInterfaceConverter.convert(iBinder);
                try {
                    listener.onServiceConnected(service);
                } catch (RemoteException e) {
                    Log.INSTANCE.e(TAG, "onServiceConnected: ", e);
                } finally {
            ...
            public void onServiceDisconnected(ComponentName componentName) {
                Log.INSTANCE.e(TAG, "onServiceDisconnected() called");
                mContext.unbindService(this);
            }
        };
        try {
            ...
            Log.INSTANCE.e(TAG, "Cannot bind to user " + mTargetUserHandle, e);
            return false;
        }
    }
}
